...
| FreeRTOS-Plus-FAT | `FreeRTOS/Lab-Project-FreeRTOS-FAT` | branch `main` (Labs project — no release tags) | `8d38036c9344bb913083e4842b1a7b7c01e2daac` |
...
The MIDDLE image FROMs `cpputest:sha-2c7b76b` directly:
